    ...
    public async Task SeedAsync()
    {
        try
        {
            ...
            var case1 = new Case
            {
                ...
                CaseBackground = "Civil property dispute regarding land ownership in Mumbai",
                CaseType = "Civil",
                CourtName = "Mumbai High Court",
                Status = CaseStatus.Active,
                FiledDate = DateTime.UtcNow.AddMonths(-3),
                PrivateNotes = "Key witness identified. Need to prepare cross-examination.",
                ClientInstructions = "Case is progressing well. Next hearing scheduled."
            };
            ...
            var case2 = new Case
            {
                ...
                CaseBackground = "Commercial contract breach case involving service agreements",
                CaseType = "Commercial",
                CourtName = "Delhi District Court",
                Status = CaseStatus.Pending,
                FiledDate = DateTime.UtcNow.AddMonths(-1),
                PrivateNotes = "Awaiting documents from opposing counsel.",
                ClientInstructions = "Initial paperwork submitted."
            };
